...
const
     ...
     STR_MP            = 'Delfi Zip Self-Extractor';
     STR_EXPT          = 'Molim Vas, izaberite destinacioni direktorijum';
     STR_RUN           = 'Posle dekompresije, pokreni : ';
     STR_BROWSECAP     = 'Dekompresuj : ';
     STR_BTNFOLD       = 'Novi...';
     STR_EINC_SIZE     = 'Neispravna velicina fajla, molim Vas, probajte ponovo.';
     STR_ABOUT_CAP     = 'O Delfi Zip Self-Extractor-u...';
     STR_ABOUT_MSG     = ' © 1997-1998 by C. Bunton, E. W. Engler, M. Stephany'+N+N+
